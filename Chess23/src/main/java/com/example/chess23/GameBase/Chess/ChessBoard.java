...
public class ChessBoard extends Board {
    ...
    public void newField() {
        this.resetField();
        // white
        field[0][0] = new Rook(true, new Coordinate(0, 0),this);
        field[0][1] = new Knight(true, new Coordinate(1, 0));
        field[0][2] = new Bishop(true, new Coordinate(2, 0),this);
        field[0][3] = new Queen(true, new Coordinate(3, 0),this);
        field[0][4] = new King(true, new Coordinate(4, 0),this);
        field[0][5] = new Bishop(true, new Coordinate(5, 0),this);
        field[0][6] = new Knight(true, new Coordinate(6, 0));
        field[0][7] = new Rook(true, new Coordinate(7, 0),this);
        for (int i = 0; i < chessFieldSize; i++)
            field[1][i] = new Pawn(true, new Coordinate(i, 1));
        //black
        field[7][0] = new Rook(false, new Coordinate(0, 7),this);
        field[7][1] = new Knight(false, new Coordinate(1, 7));
        field[7][2] = new Bishop(false, new Coordinate(2, 7),this);
        field[7][3] = new Queen(false, new Coordinate(3, 7),this);
        field[7][4] = new King(false, new Coordinate(4, 7),this);
        field[7][5] = new Bishop(false, new Coordinate(5, 7),this);
        field[7][6] = new Knight(false, new Coordinate(6, 7));
        field[7][7] = new Rook(false, new Coordinate(7, 7),this);
        for (int i = 0; i < chessFieldSize; i++)
